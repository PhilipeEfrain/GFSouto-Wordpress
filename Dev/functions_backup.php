...
function modelo_gfsouto_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'topo_chamada_mobile', array(
        'type' => 'theme_mod',
        'default' => 'Administrando Condomínios<br>com responsabilidade.',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'topo_chamada_mobile', array(
        'label' => __( 'Chamada', 'modelo_gfsouto' ),
        'type' => 'textarea',
        'section' => 'topo'
    ));
...
if ( ! function_exists( 'modelo_gfsouto_enqueue_scripts' ) ) :
    ...
    wp_deregister_script( 'modelo_gfsouto-jquerymigrate' );
    wp_enqueue_script( 'modelo_gfsouto-jquerymigrate', get_template_directory_uri() . '/js/jquery-migrate-3.0.1.min.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-popper' );
    wp_enqueue_script( 'modelo_gfsouto-popper', get_template_directory_uri() . '/assets/js/popper.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-bootstrap' );
    wp_enqueue_script( 'modelo_gfsouto-bootstrap', get_template_directory_uri() . '/bootstrap/js/bootstrap.min.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-jqueryeasing' );
    wp_enqueue_script( 'modelo_gfsouto-jqueryeasing', get_template_directory_uri() . '/js/jquery.easing.1.3.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-jquerywaypoints' );
    wp_enqueue_script( 'modelo_gfsouto-jquerywaypoints', get_template_directory_uri() . '/js/jquery.waypoints.min.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-jquerystellar' );
    wp_enqueue_script( 'modelo_gfsouto-jquerystellar', get_template_directory_uri() . '/js/jquery.stellar.min.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-owlcarousel' );
    wp_enqueue_script( 'modelo_gfsouto-owlcarousel', get_template_directory_uri() . '/js/owl.carousel.min.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-jquerymagnificpopup' );
    wp_enqueue_script( 'modelo_gfsouto-jquerymagnificpopup', get_template_directory_uri() . '/js/jquery.magnific-popup.min.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-aos' );
    wp_enqueue_script( 'modelo_gfsouto-aos', get_template_directory_uri() . '/js/aos.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-jqueryanimatenumber' );
    wp_enqueue_script( 'modelo_gfsouto-jqueryanimatenumber', get_template_directory_uri() . '/js/jquery.animateNumber.min.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-scrollax' );
    wp_enqueue_script( 'modelo_gfsouto-scrollax', get_template_directory_uri() . '/js/scrollax.min.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-script' );
    wp_enqueue_script( 'modelo_gfsouto-script', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-googlemap' );
    wp_enqueue_script( 'modelo_gfsouto-googlemap', get_template_directory_uri() . '/js/google-map.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-main' );
    wp_enqueue_script( 'modelo_gfsouto-main', get_template_directory_uri() . '/js/main.js', false, null, true);

    wp_deregister_script( 'jquery' );
    wp_enqueue_script( 'jquery', get_template_directory_uri() . '/../assets/js/jquery.min.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-popper-1' );
    wp_enqueue_script( 'modelo_gfsouto-popper-1', get_template_directory_uri() . '/../assets/js/popper.js', false, null, true);

    wp_deregister_script( 'modelo_gfsouto-bootstrap-1' );
    wp_enqueue_script( 'modelo_gfsouto-bootstrap-1', get_template_directory_uri() . '/../bootstrap/js/bootstrap.js', false, null, true);

    /* Pinegrow generated Enqueue Scripts End */

        /* Pinegrow generated Enqueue Styles Begin */

    wp_deregister_style( 'modelo_gfsouto-horizontalslim_' );
    wp_enqueue_style( 'modelo_gfsouto-horizontalslim_', '//cdn-images.mailchimp.com/embedcode/horizontal-slim-10_7.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-style' );
    wp_enqueue_style( 'modelo_gfsouto-style', 'https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700,800,900', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-bootstrap' );
    wp_enqueue_style( 'modelo_gfsouto-bootstrap', get_template_directory_uri() . '/bootstrap/css/bootstrap.min.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-animate' );
    wp_enqueue_style( 'modelo_gfsouto-animate', get_template_directory_uri() . '/css/animate.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-owlcarousel' );
    wp_enqueue_style( 'modelo_gfsouto-owlcarousel', get_template_directory_uri() . '/css/owl.carousel.min.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-owlthemedefault' );
    wp_enqueue_style( 'modelo_gfsouto-owlthemedefault', get_template_directory_uri() . '/css/owl.theme.default.min.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-magnificpopup' );
    wp_enqueue_style( 'modelo_gfsouto-magnificpopup', get_template_directory_uri() . '/css/magnific-popup.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-aos' );
    wp_enqueue_style( 'modelo_gfsouto-aos', get_template_directory_uri() . '/css/aos.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-ionicons' );
    wp_enqueue_style( 'modelo_gfsouto-ionicons', get_template_directory_uri() . '/css/ionicons.min.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-flaticon' );
    wp_enqueue_style( 'modelo_gfsouto-flaticon', get_template_directory_uri() . '/css/flaticon.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-icomoon' );
    wp_enqueue_style( 'modelo_gfsouto-icomoon', get_template_directory_uri() . '/css/icomoon.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-style-1' );
    wp_enqueue_style( 'modelo_gfsouto-style-1', get_template_directory_uri() . '/css/style.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-fontawesome' );
    wp_enqueue_style( 'modelo_gfsouto-fontawesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-bootstrap-1' );
    wp_enqueue_style( 'modelo_gfsouto-bootstrap-1', get_template_directory_uri() . '/../bootstrap/css/bootstrap.css', false, null, 'all');

    wp_deregister_style( 'modelo_gfsouto-style-2' );
    wp_enqueue_style( 'modelo_gfsouto-style-2', get_bloginfo('stylesheet_url'), false, null, 'all');
