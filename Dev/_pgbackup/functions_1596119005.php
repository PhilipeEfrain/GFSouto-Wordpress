...
if ( ! function_exists( 'modelo_gfsouto_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'popper-1', get_template_directory_uri() . '/../assets/js/popper.js', false, null, true);

    wp_deregister_script( 'bootstrap-1' );
    wp_enqueue_script( 'bootstrap-1', get_template_directory_uri() . '/../bootstrap/js/bootstrap.js', false, null, true);
    ...
    wp_deregister_style( 'bootstrap-1' );
    wp_enqueue_style( 'bootstrap-1', get_template_directory_uri() . '/../bootstrap/css/bootstrap.css', false, null, 'all');
