                            ...
                            <div class="col-md-4 d-flex align-items-stretch">
                                <div class="services text-center">
                                    ...
                                    <div class="text">
                                        ...
                                        <p><?php echo get_theme_mod( 'servicos_texto_01', __( 'Sistema completo para administração de condomínios, desenvolvido com tecnologia moderna e uma interface amigável.', 'modelo_gfsouto' ) ); ?></p>
                                    </div>
                                    <a href="<?php echo get_theme_mod( 'servicos_link_01', '#' ); ?>" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a>
                                </div>
                            </div>
                            <div class="col-md-4 d-flex align-items-stretch">
                                <div class="services text-center">
                                    ...
                                    <div class="text">
                                        ...
                                        <p><?php echo get_theme_mod( 'servicos_texto_02', __( 'Sistema completo para administração de condomínios, desenvolvido com tecnologia moderna e uma interface amigável.', 'modelo_gfsouto' ) ); ?></p>
                                    </div>
                                    <a href="<?php echo get_theme_mod( 'servicos_link_02', '#' ); ?>" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a>
                                </div>
                            </div>
                            <div class="col-md-4 d-flex align-items-stretch">
                                <div class="services text-center">
                                    ...
                                    <div class="text">
                                        ...
                                        <p><?php echo get_theme_mod( 'servicos_texto_03', __( 'Sistema completo para administração de condomínios, desenvolvido com tecnologia moderna e uma interface amigável.', 'modelo_gfsouto' ) ); ?></p>
                                    </div>
                                    <a href="<?php echo get_theme_mod( 'servicos_link_03', '#' ); ?>" class="btn-custom d-flex align-items-center justify-content-center"><span class="ion-ios-arrow-round-forward"></span></a>
                                </div>
                            </div>
                        </div>
