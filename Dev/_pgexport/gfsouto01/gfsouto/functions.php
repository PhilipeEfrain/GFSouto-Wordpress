...
if ( ! function_exists( 'modelo_gfsouto_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'script-1', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false', false, null, true);
    ...
    wp_add_inline_script( 'inline-script-2', 'document.write(new Date().getFullYear());');

    wp_deregister_script( 'jquery' );
    wp_enqueue_script( 'jquery', get_template_directory_uri() . '/js/jquery.min.js', false, null, true);

    wp_deregister_script( 'popper-1' );
    wp_enqueue_script( 'popper-1', get_template_directory_uri() . '/js/popper.min.js', false, null, true);
    ...
    wp_enqueue_script( 'script-3', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false', false, null, true);

    wp_register_script( 'inline-script-4', '', [], '', true );
    wp_enqueue_script( 'inline-script-4' );
    wp_add_inline_script( 'inline-script-4', 'document.write(new Date().getFullYear());');

    wp_deregister_script( 'script-5' );
    wp_enqueue_script( 'script-5', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false', false, null, true);
