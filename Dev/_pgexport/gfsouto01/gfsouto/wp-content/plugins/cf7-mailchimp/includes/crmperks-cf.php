...
?>
  <div class="vx_div">
        <div class="vx_head">
<div class="crm_head_div"><i class="fa fa-bullhorn"></i> <?php _e('Marketing Data', 'contact-form-mailchimp-crm'); ?></div>
...
<p><?php _e('Need Marketing Insight? ,','contact-form-mailchimp-crm')?> <a href="<?php echo $plugin_url ?>&section=vxc_premium"><?php _e('Go Pro!','contact-form-mailchimp-crm')?></a></p>
</div>
 <?php
 }else{
...
if(!$html_added){
   ?> 
   <h3 style="text-align: center;"><?php _e('No Information Available','contact-form-mailchimp-crm')?></h3>
   <?php
}
 }
?>
