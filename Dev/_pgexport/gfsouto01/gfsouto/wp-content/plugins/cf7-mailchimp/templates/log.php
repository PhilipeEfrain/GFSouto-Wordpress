...
<div class="crm_head_div"><span class="crm_head_text"><?php _e('Data Sent','contact-form-mailchimp-crm') ?></span></div>
...
<?php
      ...
      ?>
  <div class="vx_error"><i class="fa fa-warning"></i> <?php _e('Nothing Posted to Mailchimp','contact-form-mailchimp-crm');?></div>      
      <?php
  }
?>
</div></div>
    ...
    if(is_array($response) && count($response)>0){
      ...
      ?>
        <div class="crm_panel crm_panel_50">
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php _e('Mailchimp Response','contact-form-mailchimp-crm') ?></span></div>
<div class="crm_btn_div" title="<?php _e('Expand / Collapse','contact-form-mailchimp-crm'); ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
<div class="crm_panel_head">
<div class="crm_head_div"><span class="crm_head_text"><?php _e('More Detail','contact-form-mailchimp-crm') ?></span></div>
<div class="crm_btn_div" title="<?php _e('Expand / Collapse','contact-form-mailchimp-crm'); ?>"><i class="fa crm_toggle_btn fa-minus"></i></div>
<div class="crm_clear"></div>
</div>
<div class="crm_panel_content crm-block-content">
...
?>
 ...
 if($error){
  ?>
<div class="vx_error"><i class="fa fa-warning"></i> <?php _e('Detail Not Found','contact-form-mailchimp-crm');?></div>  
  <?php   
 } ?>
...
?>
<a href="<?php echo $feed_link ?>" title="<?php _e('Edit Feed','contact-form-mailchimp-crm') ?>" class="button"><i class="fa fa-edit"></i> <?php _e('Edit Feed','contact-form-mailchimp-crm') ?></a>
<?php
    }
?>
<a href="<?php echo $log_link ?>" title="<?php _e('Open in New Window','contact-form-mailchimp-crm') ?>" target="_blank" class="button"><i class="fa fa-external-link"></i> <?php _e('Open in New Window','contact-form-mailchimp-crm') ?></a>
<a href="#" class="button vx_close_detail" title="<?php _e('Close','contact-form-mailchimp-crm') ?>"><i class="fa fa-times"></i> <?php _e('Close','contact-form-mailchimp-crm') ?></a>
