<?php get_header(); ?>
        ...
        <!-- END nav -->
        <div class="hero-wrap js-fullheight" style="background-image: url('http://localhost:40000/http://gf-souto.local/wp-content/themes/gfsouto/images/img/01.jpg');background-image:url('');background-image:<?php echo 'url('.PG_Image::getUrl( get_theme_mod( 'topo_bg' ), 'large' ).')' ?>;" data-stellar-background-ratio="0.5">
                    ...
                    <div class="col-lg-9 services-wrap px-4 pt-5">
                        <div class="row pt-md-3">
                            <div class="col-md-4 d-flex align-items-stretch">
                                <div class="services text-center">
                                    <div class="icon d-flex justify-content-center align-items-center">
                                        <img src="<?php echo PG_Image::getUrl( get_theme_mod( 'servicos_svg_01', 'http://gf-souto.local/wp-content/themes/gfsouto/images/icon/001-predio-comercial.svg' ), 'large' ) ?>" width="40">
                                        <span></span>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-md-4 d-flex align-items-stretch">
                                <div class="services text-center">
                                    <div class="icon d-flex justify-content-center align-items-center">
                                        <img src="<?php echo PG_Image::getUrl( get_theme_mod( 'servicos_svg_02', 'http://gf-souto.local/wp-content/themes/gfsouto/images/icon/001-predio-comercial.svg' ), 'large' ) ?>" width="40">
                                        <span></span>
                                    </div>
                                    <div class="text">
                            ...
                            <div class="col-md-4 d-flex align-items-stretch">
                                <div class="services text-center">
                                    <div class="icon d-flex justify-content-center align-items-center">
                                        <img src="<?php echo PG_Image::getUrl( get_theme_mod( 'servicos_svg_03', 'http://gf-souto.local/wp-content/themes/gfsouto/images/icon/001-predio-comercial.svg' ), 'large' ) ?>" width="40">
                                        <span></span>
                                    </div>
                                    <div class="text">
            ...
            <div class="container">
                <div class="row d-flex">
                    <div class="col-md-6 d-flex">
                        <div class="img img-video align-items-center d-flex justify-content-md-end justify-content-center align-self-stretch" style="background-image:url('http://localhost:40000/http://gf-souto.local/wp-content/themes/gfsouto/images/img/about.jpg');background-image:url('');background-image:<?php echo 'url('.PG_Image::getUrl( get_theme_mod( 'a_gfsouto' ), 'large' ).')' ?>;">
</div>
                    </div>
        ...
        <section class="ftco-consultation ftco-section ftco-no-pt ftco-no-pb img" style="background-image: url('http://localhost:40000/http://gf-souto.local/wp-content/themes/gfsouto/images/img/02.jpg');background-image:url('');background-image:<?php echo 'url('.PG_Image::getUrl( get_theme_mod( 'contato_imagem' ), 'large' ).')' ?>;">
            <div class="overlay"></div>
            <div class="container">
                <div class="row d-md-flex justify-content-end">
                    <div class="col-md-6 half p-3 py-5 pl-md-5 ftco-animate heading-section heading-section-white">
                        ...
                        <?php if( !$mailer->processed || $mailer->error) : ?>
                            <form action="<?php echo '#contato_cliente_mailer_id'; ?>" class="consultation" method="post" onsubmit="event.stopImmediatePropagation();event.stopPropagation();" id="contato_cliente_mailer_id">
                    ...
                    <div class="py-4 bg-primary px-md-4 col-lg-8">
                        <div class="row">
                            ...
                            <div class="d-flex align-items-center col-md-7">
                                <form action="http://gf-souto.local/wp-content/themes/gfsouto/#" class="subscribe-form">
	   ...
	   We recommend moving this block and the preceding CSS link to the HEAD of your HTML file. */</style>                             
        ...
        <footer class="ftco-footer ftco-bg-dark ftco-section">
            <div class="container">
                <div class="row mb-5">
                    <div class="col-md">
                        <img src="<?php echo PG_Image::getUrl( get_theme_mod( 'rodape_logo', 'http://gf-souto.local/wp-content/themes/gfsouto/images/img/logo.png' ), 'large' ) ?>" alt="Logo" class="img-fluid" width="auto">
