...
function modelo_gfsouto_init() {
    ...
    register_post_type('contato', array(
        'labels' => 
            array(
                'name' => __( 'Contatos', 'gfnovo' ),
                'singular_name' => __( 'Contato', 'gfnovo' )
            ),
        'public' => false,
...
function modelo_gfsouto_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'portaria_virtual_bnt', array(
        'type' => 'theme_mod',
        'default' => __( 'Saiba mais', 'gfnovo' ),
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'portaria_virtual_bnt', array(
        'label' => __( 'Botão', 'gfnovo' ),
        'type' => 'text',
        'section' => 'portaria_virtual'
    ));

    $wp_customize->add_setting( 'portaria_virtual_bnt_link', array(
        'type' => 'theme_mod',
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'portaria_virtual_bnt_link', array(
        'label' => __( 'Link do Botão', 'gfnovo' ),
        'type' => 'url',
        'section' => 'portaria_virtual'
    ));
